...
from dags.spark.transform.InsertCsvTransactionDwh import Loc_tf_update
...
pltfrm_trans = validate_count('xml_transaction')
...
Loc_tf = spark.sql("""select 
                  ...
                  'Xml_3rdparty_platfrom' As sold_by,
...
for row in Loc_tf_update.collect():
      ...
      .option("query","""update "Event_Dwh"."Transaction" 
                              ...
                              where src_trans_id = {} and sold_by='Xml_3rdparty_platfrom'
