...
def get_count_dwh():
    ...
    .option("query",'select count(*) cnt from "Event_Dwh"."{}" where ("CreateDate" = \'{}\' or "UpdateDate" = \'{}\') and sold_by=\'{}\' '.format(dest_table,run_date,run_date,src_type))\
    .option("user","airflow")\
...
def delete_dwh():
    ...
    .option("driver","org.postgresql.Driver")\
    .option("query",'delete from "Event_Dwh"."{}" where ("CreateDate" = \'{}\' or "UpdateDate" = \'{}\') and sold_by=\'{}\''.format(dest_table,run_date,run_date,src_type))\
    .option("user","airflow")\
